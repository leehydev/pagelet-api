...
- [x] `admin-post-v2.controller.ts` 생성
- [x] 모듈에 컨트롤러 등록
- [x] 테스트

### Phase 2: Settings v2

- [x] `admin-site-settings-v2.controller.ts` 생성
- [x] 모듈에 컨트롤러 등록
- [x] 테스트

### Phase 3: Uploads & Branding v2

- [x] `admin-upload-v2.controller.ts` 생성
- [x] `admin-branding-asset-v2.controller.ts` 생성
- [x] 모듈에 컨트롤러 등록
- [x] 테스트

### Phase 4: Banners v2

- [x] `admin-banner-v2.controller.ts` 생성
- [x] 모듈에 컨트롤러 등록
- [x] 테스트

### Phase 5: Analytics v2

- [x] `admin-analytics-v2.controller.ts` 생성
- [x] 모듈에 컨트롤러 등록
- [x] 테스트
...
- [x] 각 v2 엔드포인트 X-Site-Id 헤더로 호출
- [x] 헤더 누락 시 400 에러 확인
- [x] 권한 없는 사이트 접근 시 403 에러 확인
