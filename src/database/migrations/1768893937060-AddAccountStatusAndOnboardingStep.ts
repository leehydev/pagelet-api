...
export class AddAccountStatusAndOnboardingStep1768893937060 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "account_status" character varying(20) NOT NULL DEFAULT 'ONBOARDING'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "social_accounts" ADD "provider" "pagelet"."social_accounts_provider_enum" NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "social_accounts" ADD "provider" social_accounts_provider_enum NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_4508a993f9340ca4e7547db4ff" ON "social_accounts" ("provider", "provider_user_id") `,
    );
