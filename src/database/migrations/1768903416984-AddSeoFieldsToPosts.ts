...
export class AddSeoFieldsToPosts1768903416984 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "posts" ADD "slug" character varying(255) NOT NULL DEFAULT gen_random_uuid()`);
        await queryRunner.query(`CREATE TYPE "pagelet"."posts_status_enum" AS ENUM('DRAFT', 'PUBLISHED')`);
        await queryRunner.query(`ALTER TABLE "posts" ADD "status" "pagelet"."posts_status_enum" NOT NULL DEFAULT 'DRAFT'`);
