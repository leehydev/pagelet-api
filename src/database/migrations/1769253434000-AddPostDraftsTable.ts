...
export class AddPostDraftsTable1769253434000 implements MigrationInterface {
  name = 'AddPostDraftsTable1769253434000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "post_drafts" (
        ...
        "subtitle" character varying(500) NOT NULL DEFAULT '',
        "content_json" jsonb,
        "content_html" text,
        "content_text" text,
