...
export class InitialSchema1769482970823 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_26503a75e987672fb5af9258cc" ON "sites" ("slug") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_69d4cd477ab55637aed872c0e3" ON "categories" ("site_id", "slug") `,
    );
    await queryRunner.query(
      `CREATE TABLE "site_banners" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "site_id" uuid NOT NULL, "post_id" uuid NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "start_at" TIMESTAMP WITH TIME ZONE, "end_at" TIMESTAMP WITH TIME ZONE, "display_order" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_681a819ed11b0f8953c02e09f88" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "page_views" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "site_id" uuid NOT NULL, "post_id" uuid, "visitor_id" character varying(64) NOT NULL, "viewed_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3b1047277a9c2a8cfd618787671" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6b02f0b1a265c0183d06cc7b78" ON "page_views" ("post_id", "viewed_at") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_eab329ebc3dd0a7a9106e04d65" ON "page_views" ("site_id", "viewed_at") `,
    );
    await queryRunner.query(
      `CREATE TABLE "cta_clicks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "site_id" uuid NOT NULL, "post_id" uuid, "visitor_id" character varying(64) NOT NULL, "clicked_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_59fc6ba238d0f375e93b41fd06a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b1831e1c73117f73fb0d198f2a" ON "cta_clicks" ("site_id", "clicked_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sites" ADD CONSTRAINT "FK_24c21d04fcce0511d6c52ed9659" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "posts" ADD CONSTRAINT "FK_eb84ec16b52b3ff2ad794b33bc9" FOREIGN KEY ("site_id") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "posts" ADD CONSTRAINT "FK_852f266adc5d67c40405c887b49" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_drafts" ADD CONSTRAINT "FK_22504e046765cb8e482d4c5437c" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_drafts" ADD CONSTRAINT "FK_3e4e6fdeb9e335cad9c8f3b6ec2" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "site_banners" ADD CONSTRAINT "FK_acafec7d93db0712111d1238ed5" FOREIGN KEY ("site_id") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "site_banners" ADD CONSTRAINT "FK_158eb5b0134858cdcd9af9cd05d" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "page_views" ADD CONSTRAINT "FK_f5237f5fe9ecb1bb0c98d461d03" FOREIGN KEY ("site_id") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cta_clicks" ADD CONSTRAINT "FK_ca0dfe2b0ff281555d3c4d0ed3d" FOREIGN KEY ("site_id") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "cta_clicks" DROP CONSTRAINT "FK_ca0dfe2b0ff281555d3c4d0ed3d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "page_views" DROP CONSTRAINT "FK_f5237f5fe9ecb1bb0c98d461d03"`,
    );
    await queryRunner.query(
      `ALTER TABLE "site_banners" DROP CONSTRAINT "FK_158eb5b0134858cdcd9af9cd05d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "site_banners" DROP CONSTRAINT "FK_acafec7d93db0712111d1238ed5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "categories" DROP CONSTRAINT "FK_411cbb14d7ab96d475a721c1cfe"`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_drafts" DROP CONSTRAINT "FK_3e4e6fdeb9e335cad9c8f3b6ec2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_drafts" DROP CONSTRAINT "FK_22504e046765cb8e482d4c5437c"`,
    );
