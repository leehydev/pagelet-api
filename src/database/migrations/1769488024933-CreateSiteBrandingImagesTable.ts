...
export class CreateSiteBrandingImagesTable1769488024933 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "site_branding_images" ADD CONSTRAINT "FK_2b33489176a18f806647213b9d8" FOREIGN KEY ("site_id") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "site_branding_images" DROP CONSTRAINT "FK_2b33489176a18f806647213b9d8"`,
    );
